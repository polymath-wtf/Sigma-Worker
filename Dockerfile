...
RUN if [ "$MODEL_TYPE" = "flux2-klein-9b-fp8" ]; then \
  wget --header="Authorization: Bearer $HUGGINGFACE_ACCESS_TOKEN" -O /comfyui/models/unet/flux-2-klein-9b-fp8.safetensors https://huggingface.co/black-forest-labs/FLUX.2-klein-9b-fp8/resolve/main/flux-2-klein-9b-fp8.safetensors && \
